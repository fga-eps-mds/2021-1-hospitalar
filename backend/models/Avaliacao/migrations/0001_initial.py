        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avaliacao', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='Avaliacao.avaliacao')),
            ],
        ),
        migrations.CreateModel(
            name='Subtopico',
            fields=[
                ...
                ('status', models.CharField(choices=[('C', 'Conforme'), ('PC', 'Parcialmente Conforme'), (
                    'NC', 'Nao Conforme'), ('NA', 'Nao Aplica')], default='NA', max_length=2)),
                ('pontuacao', models.FloatField(default=0)),
                ('comentario', models.TextField(blank=True)),
                ('secao', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='Avaliacao.secao')),
            ],
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, to='Avaliacao.configuracao'),
        ),
    ]
