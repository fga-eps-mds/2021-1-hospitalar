...
| Perfil Administrador | H02 | Oficial  | editar login                                  | possa realizar modificações no _username_ e na senha, caso os esqueça                                              | Média      |
...
| Perfil Administrador | H05 | Oficial  | adicionar índice                              | possa distinguir a seção                                                                                           | Alta       |
...
| Perfil Administrador | H09 | Oficial  | ver o status da avaliação                     | seja evidenciado a falta, ou não, do comentário do paciente com avaliação "não conforme" e "parcialmente conforme" | Baixa      |
